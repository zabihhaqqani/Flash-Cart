    ...
    <>
      <div className="cart-checkout-container">
        {cartData?.length <= 0 ? (
          ...
          <h3 style={{ margin: "1rem" }}>My Cart ({cartData?.length})</h3>
        )}
        {
          <div className="categories-container">
            {cartData?.length <= 0 ? (
              ...
              cartData?.map((product) => {
                const { _id, name, price, category, qty, url, rating } =
                  product;
                return (
                  <div
                  ...
                  >
                    ...
                    >
                      <p>
                        <img height="200px" width="210px" src={url} alt="" />
                      </p>
                      <h3>{name}</h3>
                      <p>₹{price}</p>
                      <p>₹{category}</p>
            ...
            {cartData?.length <= 0 ? (
              ...
              <div style={{ textAlign: "left" }} className="checkout-card">
                ...
                <hr />
                <div className="inner-card-cart">
                  <p style={{ padding: "0.2rem" }}>Total Amount: </p>
                  <p>
                    ₹
                    {cartData?.reduce(
